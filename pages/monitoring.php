                ...
                <tbody>
                    <?php if ($totalData > 0) { ?>
                        <?php while ($row = mysqli_fetch_assoc($query)) { 
                            $status = $row['status_early_warning'] ?? 'Belum Diproses';
                            $statusClass = '';
                            if ($status === 'Sangat Baik') $statusClass = 'status-baik';
                            elseif ($status === 'Aman') $statusClass = 'status-aman';
                            elseif ($status === 'Waspada') $statusClass = 'status-waspada';
                            elseif ($status === 'Kritis') $statusClass = 'status-kritis';
                        ?>
                        <tr>
